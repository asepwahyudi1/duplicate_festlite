...
Route::group(['middleware' => 'auth:sanctum', 'namespace' => 'Student', 'prefix' => 'parent'], function () {
    ...
    Route::get('/students/details', [GuardianController::class, 'getStudentByGuardianDeatails']);
    ...
    Route::get('student/attendance', [GuardianController::class, 'getStudentsAttendance']);
    Route::get('/students/homeworks', [GuardianController::class, 'getStudentHomeworks']);
    Route::get('/student/syllabuses-terms', [GuardianController::class, 'getStudentSylabusesTerms']);
