...
// Route::get('ppdb', [StudentController::class, 'ppdb']);
// Route::get('ppdb', [RegisterController::class, 'create']);
...
Route::get('test', function () {
    ...
    // return auth()->user()-in>student->id;
...
// Route::post('quote', QuoteController::class)->only(['store']);
