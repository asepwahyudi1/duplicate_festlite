...
//   "joining_letter" => "joining_letters/FILE_62b1eb02ccf3b62b1eb02.pdf",
//   "resume" => "resumes/FILE_62b1eb02cd81262b1eb02.pdf",
//         ];
//         dd(Staff::create($data));
        // $accountant = Staff::create($data);
        // User info
