...
class TeacherController extends Controller
{
    ...
    {
        // User info
        $user_data = $request->only('name', 'email', 'password','roll_no');
        ...
        $teacher_data['roll_no'] = $request->roll_no;
        ...
        // dd(Staff::create($teacher_data));
        $teacher = Staff::create($teacher_data);
        // dd($teacher_data, $teacher);
    ...
    {
        // dd($teacher->load('user', 'department'));
        //Need Improvements
    ...
    public function update(UpdateTeacherRequest $request, Staff $teacher)
    {
        ...
        // Teacher info
        $teacher_data = $request->only('department_id', 'joining_date', 'phone', 'gender','roll_no');
