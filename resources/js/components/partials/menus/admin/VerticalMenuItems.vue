    ...
    <ul class="navbar-nav" :class="listClass">
        ...
        <li class="nav-item">
            <a href="/scan" class="nav-link">
                ...
                <span class="nav-link-title"> Scan QR</span>
            </a>
        </li>

        <dropdown :title="$t('attendance')" :active="checkRoute(['attendence-student', 'attendence-teacher'])" v-if="
      ...
      ">
            ...
            <router-link :to="{ name: 'quote' }" class="dropdown-item" :class="{ active: checkRoute('quote') }"
