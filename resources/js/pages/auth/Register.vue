<template>
    <div>
        <form class="card card-md" @submit.prevent="userRegistration" autocomplete="off">
            <div class="card-body">
                <h2 class="card-title text-center mb-4">PENDAFTARAN PESERTA DIDIK BARU (PPDB)</h2>
                <div class="mb-3">
                    <label class="form-label">Jurusan</label>
                    <select name="jurusan" id="jurusan" class="form-control">
                        <option value="TB">Tata Busana (TB)</option>
                        <option value="TKR">Teknik Kendaraan Ringan (TKR)</option>
                        <option value="ATPH">Argibisnis Tanaman Pangan Holtikultura (ATPH)</option>
                ...
                <div class="card-header">
                    <h6 class="card-title">A. Keterangan Pribadi Siswa</h6>
                </div>
                <br>
                <div class="mb-3">
                ...
                <br>
                <div class="card-header">
                    <h6 class="card-title">B. Keterangan Tempat Tinggal</h6>
                </div>
                <br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label">Jarak Kesekolah</label>
                    <input type="text" class="form-control" />
                </div>
                <div class="mb-3">
                ...
                <br>
                <div class="card-header">
                    <h6 class="card-title">C. Keterangan Jasmani & Kesehatan</h6>
                </div>
                <br>
                <div class="mb-3">
                ...
                <br>
                <div class="card-header">
                    <h6 class="card-title">D. Keterangan Sekolah Sebelumnya</h6>
                </div>
                <br>
                <div class="mb-3">
                ...
                <br>
                <div class="card-header">
                    <h6 class="card-title">E. Keterangan Orang Tua</h6>
                </div>
                <br>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" :placeholder="'Masukkan Nomor Handphone'"
                        ...
                        :class="{ 'is-invalid': registerUserForm.errors.has('phone') }" />
                    <has-error :form="registerUserForm" field="phone"></has-error>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="form-label">Jenis Kelamin</div>
                    <label class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" checked="" name="gender" value="male" v-model="registerUserForm.gender">
                        <span class="form-check-label">Laki - laki</span>
                    </label>
                    <label class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" value="female" v-model="registerUserForm.gender">
                        <span class="form-check-label">Perempuan</span>
                    </label>
                </div>
                <div class="mb-3">
