        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-pretitle">{{ $route.meta.title }}</h2>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-10 col-xl-6">
                            <form @submit.prevent="sendMessage" autocomplete="off">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="description">Quote</label>
...
export default {
    ...
    methods: {
        ...
        async sendMessage() {
            try {
                const response = await this.form.post(`/quote`);
                this.reset();
                this.toastSuccess(response.data.description);
            } catch (error) {
                this.toastError(error.response.data.description);
                console.log(error);
            }
        },
        async getRoles() {
            try {
                const response = await axios.get(`/api/quotes/get-roles`);
