                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="roll_no" class="form-label">ID</label>
                                        <base-input :form="teacherForm" field="roll_no" v-model="teacherForm.roll_no">
                                        </base-input>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input @change="handleJoiningLetterUpload"
                                            :class="{ 'is-invalid': teacherForm.errors.has('joining_letter') }"
                                            type="file" class="form-control" ref="joining_letter" />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input @change="handleResumeUpload"
                                            :class="{ 'is-invalid': teacherForm.errors.has('resume')  }" type="file"
                                            class="form-control" ref="resume" />
