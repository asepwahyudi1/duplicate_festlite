<template>
    <div>
        ...
        <header class="navbar navbar-expand-md navbar-light d-print-none"
            ...
            <div :class="setting.layout == 'boxed' ? 'container-xl' : 'container-fluid'">
                <button @click.prevent="navToggler = !navToggler" :aria-expanded="navToggler ? true : false"
                    :class="navToggler ? '' : 'collapsed'" class="navbar-toggler" type="button"
                    ...
                    <div class="nav-item dropdown show" @click.prevent="navDropDown = !navDropDown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm"
                                :style="{ backgroundImage: `url(${user.image_url})` }"></span>
        ...
        <div class="page-wrapper">
            <div :class="setting.layout == 'boxed' ? 'container-xl' : 'container-fluid'">
                <div class="page-header d-print-none mt-" style="min-height:unset">
